...
const knowledgeBase: KnowledgeBaseEntry[] = [
  ...
  {
    keywords: ["language", "switch language", "change language", "multilingual", "translate", "10 languages"],
    response: {
      en: "Our platform supports **10 languages**: English, German, French, Spanish, Italian, Chinese (Simplified), Japanese, Korean, Russian, and Arabic.\n\n**To switch languages:**\n1. Click the **Language** button in the header navigation\n2. Select your preferred language\n3. The entire interface will update to your selected language\n\nAll compliance documents and reports can also be generated in multiple languages.",
      de: "Unsere Plattform unterstützt **10 Sprachen**. **So wechseln Sie die Sprache:**\n1. Klicken Sie auf **Sprache** in der Navigation\n2. Wählen Sie Ihre bevorzugte Sprache\n3. Die Oberfläche wird aktualisiert",
      fr: "Notre plateforme prend en charge **10 langues**. **Pour changer de langue :**\n1. Cliquez sur **Langue** dans la navigation\n2. Sélectionnez votre langue préférée\n3. L'interface se mettra à jour",
      es: "Nuestra plataforma admite **10 idiomas**. **Para cambiar de idioma:**\n1. Haga clic en **Idioma** en la navegación\n2. Seleccione su idioma preferido\n3. La interfaz se actualizará",
      it: "La nostra piattaforma supporta **10 lingue**. **Per cambiare lingua:**\n1. Fai clic su **Lingua** nella navigazione\n2. Seleziona la lingua preferita\n3. L'interfaccia si aggiornerà",
      zh: "我们的平台支持**10种语言**：英语、德语、法语、西班牙语、意大利语、中文（简体）、日语、韩语、俄语和阿拉伯语。\n\n**切换语言的方法：**\n1. 点击头部导航栏中的**语言**按钮\n2. 选择您偏好的语言\n3. 整个界面将更新为您选择的语言",
      ja: "当プラットフォームは**10言語**をサポートしています。**言語切替方法：**\n1. ヘッダーの**言語**ボタンをクリック\n2. 希望の言語を選択\n3. インターフェースが更新されます",
      ko: "당사 플랫폼은 **10개 언어**를 지원합니다. **언어 변경 방법:**\n1. 헤더 나이게이션의 **언어** 버튼 클릭\n2. 원하는 언어 선택\n3. 인터페이스가 업데이트됩니다",
    },
  },
];
