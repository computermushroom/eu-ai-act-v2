-- ============================================================
-- PostgreSQL DDL - EU AI Act Compliance Tool
...
-- accounts -> users (onDelete: Cascade)
ALTER TABLE "accounts"
  ADD CONSTRAINT "accounts_userId_fkey"
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- sessions -> users (onDelete: Cascade)
ALTER TABLE "sessions"
  ADD CONSTRAINT "sessions_userId_fkey"
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- subscriptions -> users (onDelete: Cascade)
ALTER TABLE "subscriptions"
  ADD CONSTRAINT "subscriptions_userId_fkey"
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- audit_logs -> users (onDelete: SetNull)
ALTER TABLE "audit_logs"
  ADD CONSTRAINT "audit_logs_userId_fkey"
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- ai_systems -> users (onDelete: Cascade)
ALTER TABLE "ai_systems"
  ADD CONSTRAINT "ai_systems_userId_fkey"
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- scan_results -> ai_systems (onDelete: Cascade)
ALTER TABLE "scan_results"
  ADD CONSTRAINT "scan_results_systemId_fkey"
  FOREIGN KEY ("systemId") REFERENCES "ai_systems"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- scan_tasks -> users (onDelete: Cascade)
ALTER TABLE "scan_tasks"
  ADD CONSTRAINT "scan_tasks_userId_fkey"
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- compliance_alerts -> users (onDelete: Cascade)
ALTER TABLE "compliance_alerts"
  ADD CONSTRAINT "compliance_alerts_userId_fkey"
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- fria_assessments -> ai_systems (onDelete: Cascade)
ALTER TABLE "fria_assessments"
  ADD CONSTRAINT "fria_assessments_systemId_fkey"
  FOREIGN KEY ("systemId") REFERENCES "ai_systems"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- qms_checklists -> ai_systems (onDelete: Cascade)
ALTER TABLE "qms_checklists"
  ADD CONSTRAINT "qms_checklists_systemId_fkey"
  FOREIGN KEY ("systemId") REFERENCES "ai_systems"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- training_progress -> users (onDelete: Cascade)
ALTER TABLE "training_progress"
  ADD CONSTRAINT "training_progress_userId_fkey"
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- training_progress -> training_modules (onDelete: Cascade)
ALTER TABLE "training_progress"
  ADD CONSTRAINT "training_progress_moduleId_fkey"
  FOREIGN KEY ("moduleId") REFERENCES "training_modules"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- compliance_documents -> users (onDelete: Cascade)
ALTER TABLE "compliance_documents"
  ADD CONSTRAINT "compliance_documents_userId_fkey"
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- compliance_documents -> ai_systems (onDelete: SetNull)
ALTER TABLE "compliance_documents"
  ADD CONSTRAINT "compliance_documents_systemId_fkey"
  FOREIGN KEY ("systemId") REFERENCES "ai_systems"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- team_members -> users (onDelete: Cascade)
ALTER TABLE "team_members"
  ADD CONSTRAINT "team_members_userId_fkey"
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- client_portals -> users (onDelete: Cascade)
ALTER TABLE "client_portals"
  ADD CONSTRAINT "client_portals_userId_fkey"
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- clients -> client_portals (onDelete: Cascade)
ALTER TABLE "clients"
  ADD CONSTRAINT "clients_portalId_fkey"
  FOREIGN KEY ("portalId") REFERENCES "client_portals"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- client_ai_systems -> clients (onDelete: Cascade)
ALTER TABLE "client_ai_systems"
  ADD CONSTRAINT "client_ai_systems_clientId_fkey"
  FOREIGN KEY ("clientId") REFERENCES "clients"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- client_documents -> clients (onDelete: Cascade)
ALTER TABLE "client_documents"
  ADD CONSTRAINT "client_documents_clientId_fkey"
  FOREIGN KEY ("clientId") REFERENCES "clients"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- client_alerts -> clients (onDelete: Cascade)
ALTER TABLE "client_alerts"
  ADD CONSTRAINT "client_alerts_clientId_fkey"
  FOREIGN KEY ("clientId") REFERENCES "clients"("id") ON DELETE CASCADE ON UPDATE CASCADE;
